simpleAnnotation <- function(dataA, max.mz.diff = 10, 
    ...
    if (length(adduct_names) > 1) {
        l2 <- parLapply(cl, s1, Annotationbychemical_IDschild, 
            ...
            otherdbs = FALSE, otherinfo = FALSE, adduct_table = adduct_table)
    ...
    # levelB_res[which(levelB_res$mz>175.117 &
    # levelB_res$mz<175.119),1:8]
