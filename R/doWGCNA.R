doWGCNA <- function(data_m, deepsplit = 4, minclustsize = 1, 
    ...
    hierTOMdataOne = hclust(as.dist(dissTOMdataOne), 
        method = "complete")
    par(mfrow = c(1, 1))
    pdf("plot.pdf")
    ...
    # dissTOMdataOne,deepSplit=2, pamRespectsDendro =
    # FALSE)
    ...
    colorhdataOne2 = cutreeDynamic(hierTOMdataOne, 
        distM = dissTOMdataOne, deepSplit = deepsplit, 
