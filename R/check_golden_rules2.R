check_golden_rules2 <- function(curformula, NOPS_check = FALSE) {
    ...
    if (numcarbons < 1) {
        ...
        if (NOPS_check == TRUE) {
            # NOPS>1
            if (numnitrogens > 1 & numoxygens > 1 & 
                numphos > 1 & numsulphur > 1) {
                if (numnitrogens > 10 | numoxygens > 
                  20 | numphos > 4 | numsulphur > 
                  3) {
            ...
            # NOP>3
            if (numnitrogens > 3 & numoxygens > 3 & 
                numphos > 3) {
                if (numnitrogens > 11 | numoxygens > 
                  22 | numphos > 6) {
            ...
            # NOS>6
            if (numnitrogens > 6 & numoxygens > 6 & 
                numsulphur > 6) {
                if (numnitrogens > 19 | numoxygens > 
                  14 | numsulphur > 8) {
