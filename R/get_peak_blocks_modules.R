get_peak_blocks_modules <- function(dataA, simmat, 
    adjacencyfromsimilarity = FALSE, time_step = 3, 
    max.rt.diff = 10, outloc, column.rm.index = NA, 
    cor.thresh = NA, deepsplit = 2, minclustsize = 30, 
    cutheight = 0.2, networktype = "unsigned", num_nodes = 2) {
    ...
    save(consMEs, moduleLabels, moduleColors, consTree, 
        file = "Consensus-NetworkConstruction-auto_min30.RData")
