getscore <- function(k, mchemdata, chemids, corthresh, 
    global_cor, mzid, max_diff_rt, level_module_isop_annot, 
    adduct_table, adduct_weights, mass_defect_window = 0.01, 
    ...
    chem_score <- get_chemscorev1.6.71(chemicalid = chemid, 
        ...
        global_cor, mzid, max_diff_rt = max_diff_rt, 
